...
class MemberListItemResponse(BaseModel):
    ...
    is_cell_leader: Optional[bool] = Field(
        None, description="Indicates if the member is cell leader or not", alias="isCellLeader"
    )
    ...
    def set_booleans(self):
        self.is_pastor = self.cell_leadership in {CellLeadershipType.pastor_zona, CellLeadershipType.pastor_principal}
...
class MemberPersonalInformationResponse(BaseModel):
    ...
    preaching_point_id: Optional[int] = Field(description="Preaching point", alias="preachingPoint")
    ...
    zone_pastor_id: Optional[int] = Field(description="Member zone pastor data", alias="zonePastor")
...
class MemberInformationResponse(BaseModel):
    ...
    personal_information: MemberPersonalInformationResponse = Field(
        description="Member personal information", alias="personalInformation"
    )
...
class MemberFormValuesResponse(BaseModel):
    ...
    preaching_points: List[PreachingPointInformation] = Field(
        description="Preaching point list", alias="preachingPoints"
    )
