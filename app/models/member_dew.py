...
class MembersDEWResponse(BaseModel):
    ...
    is_publishing_testimony: Optional[bool] = Field(
        description="Is publishing testimony", alias="isPublishingTestimony"
    )
    is_publishing_testimony_name: Optional[bool] = Field(
        description="Is publishing testimony name", alias="isPublishingTestimonyName"
    )
